...
export const PROJECTS: Project[] = [
  {
    id: 'nova', num: '01', category: 'Brand & Three.js', title: 'NOVA Phone',
  ...
  {
    id: 'laya', num: '02', category: 'Portfolio Design', title: 'LAYA HOME',
  ...
  {
    id: 'naturhistorisk', num: '04', category: 'Brand System', title: 'Naturhistorisk Museum',
  ...
  {
    id: 'spilcafe', num: '05', category: 'Full-stack', title: 'SpilCafe',
    ...
    fallbackFrom: '#0a1428', fallbackTo: '#1A3A5C', featured: true,
  },
  {
    id: 'ecosort', num: '06', category: 'CMS App', title: 'EcoSort',
  ...
  {
    id: 'museumquiz', num: '07', category: 'Kiosk UI', title: 'Museum Quiz',
  ...
  {
    id: 'recipe', num: '08', category: 'Student Tool', title: 'Recipe Matcher',
    ...
    tags: ['React', 'Algorithm', 'Food'],
    url: 'https://recipes-ruddy-eight.vercel.app',
    screenshotA: '/screenshots/08a.jpg', screenshotB: '/screenshots/08b.jpg',
    bg: 'linear-gradient(135deg,#2a3e1a,#4A6741)',
    fallbackFrom: '#2a3e1a', fallbackTo: '#4A6741', featured: false,
  },
  {
    id: 'brickbreaker', num: '09', category: 'Game Dev', title: 'BrickBreaker',
  ...
  {
    id: 'waveform', num: '10', category: 'Web Audio', title: 'WAVEFORM',
  ...
  {
    id: 'palette', num: '11', category: 'Design Tool', title: 'PALETTE',
    ...
    bg: 'linear-gradient(135deg,#1a1a3e,#3a2060)',
    fallbackFrom: '#1a1a3e', fallbackTo: '#3a2060', featured: false,
  },
]
